...
cargo fmt --all
git add -A
git commit -m "orbiscreen | v0.22.4 | style: cargo fmt --all"
```
...
git add -A
git commit -m "orbiscreen | v0.22.4 | fix: resolve clippy warnings"
```
...
git add Cargo.lock
git commit -m "orbiscreen | v0.22.4 | chore: refresh Cargo.lock"
```
...
**Fix:**
Update to the latest release (v0.22.4 or newer).
