...
cargo fmt --all
git add -A
git commit -m "orbiscreen | v0.25.6 | style: cargo fmt --all"
```
...
git add -A
git commit -m "orbiscreen | v0.25.6 | fix: resolve clippy warnings"
```
...
git add Cargo.lock
git commit -m "orbiscreen | v0.25.6 | chore: refresh Cargo.lock"
```
...
**Fix:**
Update to the latest release (v0.25.6 or newer).
