...
cargo fmt --all
git add -A
git commit -m "orbiscreen | v0.21.0 | style: cargo fmt --all"
```
...
git add -A
git commit -m "orbiscreen | v0.21.0 | fix: resolve clippy warnings"
```
...
git add Cargo.lock
git commit -m "orbiscreen | v0.21.0 | chore: refresh Cargo.lock"
```
...
**Fix:**
Update to the latest release (v0.21.0 or newer).
