...
cargo fmt --all
git add -A
git commit -m "orbiscreen | v0.25.7 | style: cargo fmt --all"
```
...
git add -A
git commit -m "orbiscreen | v0.25.7 | fix: resolve clippy warnings"
```
...
git add Cargo.lock
git commit -m "orbiscreen | v0.25.7 | chore: refresh Cargo.lock"
```
...
**الإصلاح:**
حدّث إلى الإصدار الأخير (v0.25.7 أو أحدث).
