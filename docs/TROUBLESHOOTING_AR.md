...
cargo fmt --all
git add -A
git commit -m "orbiscreen | v0.25.3 | style: cargo fmt --all"
```
...
git add -A
git commit -m "orbiscreen | v0.25.3 | fix: resolve clippy warnings"
```
...
git add Cargo.lock
git commit -m "orbiscreen | v0.25.3 | chore: refresh Cargo.lock"
```
...
**الإصلاح:**
حدّث إلى الإصدار الأخير (v0.25.3 أو أحدث).
