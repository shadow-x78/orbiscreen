...
- **العزل الأمني المحلي:** في v0.20.0، حُصرت النقطة `/client/config.json` على الواجهة المحلية `127.0.0.1` و `::1` فقط لمنع الأجهزة الغريبة على الشبكة من سرقة التوكن عبر HTTP.
