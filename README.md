...
<img src="data/orbiscreen.svg" alt="Orbiscreen logo - the host monitor with the phone stepping in front of its corner, and the stream arc carrying the signal into it" width="180" />
