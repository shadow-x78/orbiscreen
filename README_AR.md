...
| **Orbiscreen** | Spacedesk | Deskreen | Weylus | Apple Sidecar | الميزة / الإمكانية |
| :---: | :---: | :---: | :---: | :---: | ---: |
| **✅ مبني لنظام Linux أولاً** | ❌ (ويندوز فقط) | ✅ (عبر المتصفح) | ✅ (عبر المتصفح) | ❌ (macOS فقط) | **دعم نظام Linux كمستضيف** |
| **✅ أصيل على Wayland و X11** | ❌ | ⚠️ (يتطلب Dummy Plug) | ⚠️ (شاشة مكررة فقط) | ❌ | **دعم Wayland و X11** |
| **✅ شاشة افتراضية حقيقية ومستقلة** | ✅ (ويندوز فقط) | ❌ (يحتاج وصلة وهمية) | ❌ (تكرار الشاشة فقط) | ✅ (أجهزة Apple فقط) | **شاشة ثانية ممتدة حقيقية** |
| **✅ تطبيق أصلي (Jetpack Compose)** | ✅ | ❌ (متصفح ويب فقط) | ❌ (متصفح ويب فقط) | ❌ (أجهزة iPad فقط) | **تطبيق أندرويد أصلي** |
| **✅ تسريع عتادي NVENC و VA-API** | ✅ | ❌ | ⚠️ | ✅ | **ترميز عتادي سريع** |
| **⚡ ~25-40ms** | ~50-80ms | ~150-300ms | ~80-120ms | ~30ms | **زمن استجابة فائق السرعة** |
...
| **✅ حر ومفتوح المصدر (GPL-3.0)** | ❌ (مغلق ومحتكر) | ✅ (GPL-3.0) | ✅ (AGPL-3.0) | ❌ (مغلق كلياً) | **مفتوح المصدر** |
