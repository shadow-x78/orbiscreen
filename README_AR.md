...
| Spacedesk | Deskreen | Weylus | Apple Sidecar | **Orbiscreen** | الميزة / الإمكانية |
| :---: | :---: | :---: | :---: | :---: | ---: |
| ❌ ويندوز فقط | ✅ عبر المتصفح | ✅ عبر المتصفح | ❌ macOS فقط | **✅ مبني لنظام Linux أولاً** | **دعم نظام Linux كمستضيف** |
| ❌ | ⚠️ يتطلب Dummy Plug | ⚠️ شاشة مكررة فقط | ❌ | **✅ أصيل على Wayland و X11** | **دعم Wayland و X11** |
| ✅ ويندوز فقط | ❌ يحتاج وصلة وهمية | ❌ تكرار الشاشة فقط | ✅ أجهزة Apple فقط | **✅ شاشة افتراضية حقيقية ومستقلة** | **شاشة ثانية ممتدة حقيقية** |
| ✅ | ❌ متصفح ويب فقط | ❌ متصفح ويب فقط | ❌ أجهزة iPad فقط | **✅ تطبيق أصلي (Jetpack Compose)** | **تطبيق أندرويد أصلي** |
| ✅ | ❌ | ⚠️ | ✅ | **✅ تسريع عتادي NVENC و VA-API** | **ترميز عتادي سريع** |
| ~50-80ms | ~150-300ms | ~80-120ms | ~30ms | **⚡ 25-40ms فقط** | **زمن استجابة فائق السرعة** |
| ❌ | ❌ | ⚠️ للقلم فقط | ✅ | **✅ 4095 مستوى (Krita و GIMP)** | **حساسية ضغط وميلان القلم** |
| ✅ | ❌ | ⚠️ قلم فقط | ✅ | **✅ تحكم كامل متعدد النقاط** | **لمس وفأرة وكيبورد عكسي** |
| غير متاح | ✅ | ❌ | غير متاح | **✅ بلا روت إطلاقاً** | **بدون روت (KDE و wlroots)** |
| ❌ مغلق واحتكاري | ✅ (GPL-3.0) | ✅ (AGPL-3.0) | ❌ مغلق كلياً | **✅ حر ومفتوح المصدر (GPL-3.0)** | **مفتوح المصدر** |
