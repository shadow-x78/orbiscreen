...
- **عزل أمني صارم للتوكن عبر Loopback**: حصر قراءة التوكن على الواجهة المحلية `127.0.0.1` وتحديد صلاحيات ملف التوكن بـ `0o600`، مع دعم التوثيق لمتصفحات الويب الخارجية عبر تجزئة الرابط `#token=`
